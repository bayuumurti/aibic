...
class VisitasiKoordinator extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
      ...
      <View style={{marginHorizontal: 10, marginVertical: 10}}>
        ...
        <View>
          ...
          <View
            ...
            <TouchableOpacity
              onPress={() =>
                this.props.navigation.navigate('VisitasiKoordinatorTambah')
              }>
          ...
          <View style={{marginTop: 10}}>
            <TouchableOpacity
              onPress={() =>
                this.props.navigation.navigate('VisitasiKoordinatorLihat')
              }
              style={{
                backgroundColor: '#b90000',
                borderRadius: 5,
...
export default VisitasiKoordinator;
