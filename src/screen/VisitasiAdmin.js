...
class VisitasiAdmin extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
      ...
      <View style={{marginHorizontal: 10, marginVertical: 10}}>
        ...
        <View>
          ...
          <View
            ...
            <TouchableOpacity
              onPress={() =>
                this.props.navigation.navigate('VisitasiAdminTambah')
              }>
          ...
          <View style={{marginTop: 10}}>
            <TouchableOpacity
              onPress={() =>
                this.props.navigation.navigate('VisitasiAdminLihat')
              }
              style={{
                backgroundColor: '#b90000',
                borderRadius: 5,
