...
const ProfileKoordinator = ({navigation}) => {
  return (
    <View style={{marginVertical: 10, marginHorizontal: 10}}>
      ...
      <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
        ...
        <View
          ...
          <View>
            <TouchableOpacity
              onPress={() => navigation.navigate('ProfileKoordinator')}>
              <Image
      ...
      <View
        ...
        <Text style={{color: 'black', fontWeight: '500'}}>Koordinator</Text>
      </View>
      <View style={{marginVertical: 5}}>
        <Text style={{color: 'black', fontWeight: 'bold'}}>
      ...
      <View
        ...
        <Text style={{color: 'black', fontWeight: '500'}}>
          koordinator@aibic.site
        </Text>
      </View>
      <View style={[styles.menustyle]}>
        <TouchableOpacity onPress={() => navigation.navigate('FirstSplash')}>
...
export default ProfileKoordinator;
