      ...
      <View style={{marginHorizontal: 10, marginVertical: 10}}>
        ...
        <View>
          ...
          <View style={[styles.menustyle]}>
            <TouchableOpacity
              onPress={() => this.props.navigation.navigate('Visitasi')}>
            ...
            <TouchableOpacity
              onPress={() => this.props.navigation.navigate('Monitor')}>
              <View style={[styles.iconstyle]}>
                <Image
            ...
            <TouchableOpacity
              onPress={() => this.props.navigation.navigate('PenempatanBidan')}>
              <View style={[styles.iconstyle]}>
                <Image
          ...
          <TouchableOpacity
            onPress={() => this.props.navigation.navigate('PublikasiUser')}
            style={{
              marginVertical: 10,
              flexDirection: 'row',
