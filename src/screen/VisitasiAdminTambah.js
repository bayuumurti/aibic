...
import SelectHari from './SelectHari';
import CheckBoxBangunan from './CheckBoxBangunan';

class VisitasiAdminTambah extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isiVisitasi: '',
  ...
  createVisitasi = isiVisitasi => {
    ...
    this.props.navigation.dispatch(StackActions.replace('VisitasiAdmin'));
        ...
        <ScrollView>
          <View style={{}}>
            ...
            <View style={[styles.buttonSubmit]}>
              <TouchableOpacity
                onPress={() => this.createVisitasi(this.state.IsiVisitasi)}>
...
export default VisitasiAdminTambah;
